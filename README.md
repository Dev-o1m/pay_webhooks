...
Если в Swagger вставлен JSON именно в таком виде, используй:
...
#### Вариант 2. Отмененный платеж (для симуляции отмены платежа)
...
- Если изменить сумму, `external_invoice_id`, порядок полей или формат JSON, подпись уже нужно считать заново.
